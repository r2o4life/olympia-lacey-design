...
/// Palette + typography helpers used by the Parallel Paradigm experience.
///
/// (Centralized here to avoid hard-coded colors throughout widgets.)
class ParadigmColors {
  static const Color bg = Color(0xFF020617); // slate-950
  static const Color panel = Color(0xCC020617);
  ...
  // Accent system (used for keyword motifs + highlights).
